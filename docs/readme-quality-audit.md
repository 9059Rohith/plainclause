...
| Testing | Yes | Commands checked against package scripts and `scripts/verify.ps1`; latest results in the submission report. |
...
- Linux CI, formal performance benchmarks, and independent legal/security/accessibility reviews.
